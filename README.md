...
DataFrame compiler plugin reached public preview state!
Here's [demo project](https://github.com/koperagen/df-plugin-demo) that works with IntelliJ IDEA 2024.2 Beta.
